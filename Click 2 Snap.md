...
| ---------------------------------------- | ---------------------------------------- | ------------------------ | ---------------------- | -------------------------------- | ---------------- | ------------------ |
| [Beru](https://open.uappexplorer.com/app/com.ubuntu.developer.rschroll.beru) | [source](https://github.com/rschroll/beru) | yes                      | no (requires oxide)    |                                  |                  |                    |
...
| [InstantFX](https://open.uappexplorer.com/app/instantfx.sverzegnassi) | [source](https://launchpad.net/instantfx) | yes                      | yes?                   |                                  |                  |                    |
...
| [UT Tweak Tool](https://open.uappexplorer.com/app/ut-tweak-tool.sverzegnassi) | [source](https://code.launchpad.net/~ubuntu-touch-tweak-tool-devs/ubuntu-touch-tweak-tool/trunk) | Not yet                  |                        |                                  |                  |                    |
...
| [uMatrix](https://open.uappexplorer.com/app/umatriks.larreamikel) | [source](https://github.com/LarreaMikel/uMatriks) | Not yet                  |                        |                                  |                  |                    |
